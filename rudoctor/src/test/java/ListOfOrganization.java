...
public class ListOfOrganization {
    ...
    public void sentAllParametres() {
        ...
        Response response = request.get("http://helpdoctor.tmweb.ru/public/api/profile/works/77");
    ...
    public void sentPostRequest() {
        RequestSpecification request = RestAssured.given();
        request.header("Content-Type", "application/json");
        Response response = request.post("http://helpdoctor.tmweb.ru/public/api/profile/works/77");
        int statusCode = response.getStatusCode();
